...
public class TrainParserOld implements TrainParserConstants {
    ...
    static {
        try {
            InputStream inputParams = TrainParserOld.class.getClass().getResourceAsStream(RESOURCE_PATH_PARAMS);
    ...
    public TrainParserOld(String cityFrom, String cityTo, java.sql.Date tourDate) {
...
9 :
    ...
    public static void main(String[] args) {
        TrainParserOld trainParser = new TrainParserOld("Київ", "Львів",
