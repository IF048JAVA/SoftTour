...
<div class="row">
    <div class="col-md-3 imgfont" style="margin-left:50px;"><img src="img/egypt_logo.png" id="egypt"
                                                                 onclick="parseTour('Єгипет',1,338),clearArray()"><br>Єгипет
    </div>
    <div class="col-md-1"></div>
    <div class="col-md-3 imgfont"><img src="img/greece_logo.png" id="greece"
                                       onclick="parseTour('Греція',1,372),clearArray()"><br>Греція
    </div>
    <div class="col-md-1"></div>
    <div class="col-md-3 imgfont"><img src="img/turkey_logo.png" id="turkey"
                                       onclick="parseTour('Туреччина',1,318),clearArray()"><br>Туреччина
    </div>
    <div class="col-md-1"></div>
</div>
...
<div id="indexResult" class="parent-group"
     style="visibility: hidden; text-align:center; background-color:rgba(255,255,255,0.4); border-radius:6px; padding:15px;  margin-bottom:15px;padding-bottom: 120px;">
    ...
    <div class="panel-heading cursor-pointer" data-toggle="collapse" href="#panel-element-f\${id}"
        ...
        <div id="results\${id}">
            ...
            <security:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_USER')">
                <span id="deleteButtonF\${id}" data-role="button" class="pull-right"><i
                        class="glyphicon glyphicon-star-empty cursor-pointer"
                        onclick="saveFavorites(\${id})"></i></span>
            </security:authorize>
        </div>
    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="city" id="city" class="form-control input-md"
                                                       ...
                                                       placeholder="Місто"
                                                       label class="col-md-4 control-label" for="phone">Номер
                                                телефону</label>
                                ...
                                </form:form> data-error="Введіть місто!"
                                required="required"
                                />
                            </div>
                        </div>
